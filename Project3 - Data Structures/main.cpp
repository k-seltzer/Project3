...
vector <pair<string, int>> heapSort(HashMap dataset) {
    MinHeap minHeap;
...
int main(int argc, char *argv[]) {
    ...
    ifstream dataset("C:/Users/Gator/Development/DelayStatistics/airlines.csv", ifstream::in);
    string line, token;
    ...
    vector <pair<string, int>> min = heapSort(data);
